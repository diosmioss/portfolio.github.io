...
const bodyMessage= `Full Name:${fullName.value}<br> Email:${email.
    ...
    Email.send({
        ...
        Username : "codovichcodson@gmail.com",
        Password : "009FD18E2A7E69CA3DB2C3E883022F7A03F1",
        To : 'codovichcodson@gmail.com',
        From : "codovichcodson@gmail.com",
...
ScrollReveal().reveal('.hom-content , .heading', {origin:'top'});
...
const typed= new Typed('.multiple-text' ,{
    strings:['Frontend Developer ','Digital marketing expert','Graphic Designer'],
    typeSpeed:100,
    backSpedd:100,
    backDelay:1000,
    loop:true
